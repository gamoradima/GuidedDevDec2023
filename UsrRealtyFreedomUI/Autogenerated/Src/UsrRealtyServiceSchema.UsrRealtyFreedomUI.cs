namespace Terrasoft.Configuration
{
	...
	public class UsrRealtyServiceSchema : Terrasoft.Core.SourceCodeSchema
	{
		...
		protected override void InitializeProperties() {
			...
			UId = new Guid("856ccbba-7e87-4aff-9486-feb14c25fb8e");
			Name = "UsrRealtyService";
			ParentSchemaUId = new Guid("50e3acc0-26fc-4237-a095-849a1d534bd3");
			CreatedInPackageId = new Guid("7560b7e5-afe5-410a-ba52-1815d3492787");
			ZipBody = new byte[] { 31,139,8,0,0,0,0,0,4,0,211,211,3,0,28,22,8,150,2,0,0,0 };
		}
		...
		public override void GetParentRealUIds(Collection<Guid> realUIds) {
			...
			realUIds.Add(new Guid("856ccbba-7e87-4aff-9486-feb14c25fb8e"));
		}
