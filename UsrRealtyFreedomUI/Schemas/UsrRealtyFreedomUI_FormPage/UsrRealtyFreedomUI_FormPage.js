	...
	return {
		viewConfigDiff: /**SCHEMA_VIEW_CONFIG_DIFF*/[
			...
			},
			{
				...
				"values": {
					"type": "crt.MenuItem",
					"caption": "#ResourceString(MenuItem_s5fncnm_caption)#",
					"visible": true,
					"clicked": {
			...
			{
				"operation": "insert",
				"name": "MenuItem_bshj8h4",
				"values": {
					"type": "crt.MenuItem",
					"caption": "#ResourceString(MenuItem_bshj8h4_caption)#",
					"visible": true,
					"clicked": {
						"request": "crt.RunBusinessProcessRequest",
						"params": {
		...
		handlers: /**SCHEMA_HANDLERS*/[
			...
			},
			{
				...
				handler: async (request, next) => {
					...
					var typeObject = await request.$context.LookupAttribute_iziicor;
					var typeId = "";
					if (typeObject) {
					...
					var offerTypeObject = await request.$context.LookupAttribute_0mdj0qo;
					var offerTypeId = "";
					if (offerTypeObject) {
